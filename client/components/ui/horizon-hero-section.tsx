...
export const Component = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      refs.mountains.forEach((mountain, i) => {
        const speed = 1 + i * 0.9;
        const targetZ = (mountain.userData as MountainUserData).baseZ + scrollY * speed * 0.5;
        if (refs.nebula) {
  ...
  const sections = [
    {
      title: "LANTERN",
      line1: "They trade on what they know.",
      line2: "Now you can see it.",
    },
    {
      title: "TRACK",
      line1: "Every trade from politicians, executives, and fund managers.",
      line2: "Pulled from public SEC and congressional filings.",
    },
    {
      title: "ANALYZE",
      line1: "AI reads each filing and scores the signal behind every move.",
      line2: "Context and conviction — not just the numbers.",
    },
  ] as const;
  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style">
      ...
      <div ref={menuRef} className="side-menu" style={{ visibility: "hidden" }}>
        <Link href="/login" className="menu-link" aria-label="Log in or sign up">
        ...
        <div className="vertical-text">LANTERN</div>
      </div>

      <div className="hero-content cosmos-content">
        <h1 ref={titleRef} className="hero-title hero-title-only">
          {splitTitle(sections[0].title)}
        </h1>

        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle hero-subtitle-below">
      ...
      <div className="scroll-sections">
        {sections.slice(1).map((section) => (
          <section key={section.title} className="content-section">
            <h1 className="hero-title section-title hero-title-only">{section.title}</h1>

            <div className="hero-subtitle cosmos-subtitle hero-subtitle-below">
